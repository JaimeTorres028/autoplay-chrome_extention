...
This Chrome extension automatically starts videos on Canvas pages that embed Kaltura players and can move to the next Canvas module item after a video finishes.
